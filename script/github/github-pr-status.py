...
if __name__ == '__main__':
    ...
    for pr, labels, reviews in open_pulls.values():
        ...
        # Step 1: Get the list of 'ready-for-review' PRs that do not have
        # an assigned reviewer
        if 'ready-for-review' in labels and \
        ...
        # Step 2: Get the list of PRs that are 'ready-for-review'
        # and have a reviewer, but that reviewer hasn't put anything in yet
        # Or they are 'ready-to-merge' but not merged
        if 'ready-for-review' in labels or \
